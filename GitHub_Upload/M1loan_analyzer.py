...
print(f"The total value of all loans is ${total_amount}.")
...
average_number = total_amount / number_of_loans
print(f"The average loan amount is ${average_number: .2f}.")
...
print(f"The remaining period of the loan is {remaining_months} months.")
...
present_value_new_loan = calculate_present_value(new_loan.get("future_value"),new_loan.get("remaining_months"),annual_discount_rate)
